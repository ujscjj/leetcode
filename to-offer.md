...
> 在介绍到项目经验时，应聘者不必详述项目的背景，而要**突出介绍自己完成的工作及取得的成绩**。
...
> 不要问薪水，不要立即打听面试结果；可以问问部门的**具体业务、新人培养计划、工作环境**等。
...
>
> 如果面试题是求某个问题的最优解，并且该问题可以分为多个子问题，那么应该尝试使用**动态规划**；使用数组保存子问题的最优解。如果分解子问题的时候存在某个最特优的选择，那么该题可能适用于**贪婪算法**。
>
